...
After you have accessed the `hw01` repository (see above), follow these steps. Whenever possible, this will be the preferred route for setting up your R projects:
...
* Links
* A summary and reflection of the Git/GitHub workflow you adopted for this homework, and of your experience with Markdown (e.g., provide a summary of the workflow you adopted; then add some comments about something new you learned, something that surprised you, etc.)
...
* At least two R code chunks:
  * Rely on the in-class materials "intro to R" as starting point, but do not copy the exact code we have seen in class: make some changes to customize/expand it
...
To submit the assignment, simply push to your repository the last version of your assignment before the deadline. Then copy your repository URL (e.g. https://github.com/css-fall22/hw1-brinasab) and submit it to Canvas under HW01.
