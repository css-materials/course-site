...
In HW01 you've demonstrated knowledge of your software setup. The goal of this second assignment is to practice transforming and visually exploring data with `dplyr` and `ggplot2`.
...
# Assignment description: exploring the mass shooting dataset
...
* First push to your repository the last version of your assignment before the deadline. Make sure to stage-commit-push:
  ...
  *  `mass-shootings.md` (you will generate this file from the .Rmd by simply knitting it)
  * `mass-shootings_files/` (this folder contains all the graphs that you generated in your `.Rmd`)

* When you are ready to submit, copy your repository URL (e.g. https://github.com/css-fall23/hw2-brinasab) and submit it to Canvas under HW02 before the deadline. Do not submit files on Canvas, we only need the link to your repository 

As part of your submission, write 1-2 paragraphs of reflections on what was hard/easy about this homework, problems you solved and how, extra resources you consulted, etc. Please, list the first and last name of eventual collaborators with whom you worked with to complete this assignment.
