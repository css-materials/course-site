...
date: 2024-06-18T13:30:00-06:00  # Schedule page publish date
type: book
toc: true
draft: true
...
* Go [at this link](ADD LINK) to accept the invitation and create your private `hw02` repository on GitHub. Once you do so, your repo will be built in a few seconds. It follows the naming convention `hw02-<USERNAME>`
...
For all questions drop missing data when appropriate (consult the assigned readings, especially Chapter 7 of the book).
...
* As part of your submission, at the end of the .Rmd for this homework:
