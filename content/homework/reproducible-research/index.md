...
* A few sentences with the the purpose of the repository. For example: "This repo includes the data (include sample size and data source) and code for a project that investigate x and y", etc.
