...
* Code Organization: 
  *  Include relevant output but omit lengthy, irrelevant, and hard-to-read output (e.g., include the head of the data but not the full print, suppress irrelevant messages, etc.).
  * Ensure your code reflects the topics we have covered in the course, including coding style, reproducible workflow, and the use of Markdown syntax (customize your final document using Markdown options).
...
### Guidelines for your repository
