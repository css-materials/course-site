...
<!-- NOTES TO IMPROVE CURRENT LOOP SLIDES FALL 2024
...
Procedure: take the mean function, and apply it to each column of the data frame. Recall, we can use the `$` sign to access columns within a data frame.
