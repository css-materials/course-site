...
* **`while` loop**: execute a loop while a condition is true (and stops as long as the condition is evaluated as false)

<!-- We will now explain each and do practice exercises, but make sure to review the assigned readings for details: one is from Chapter 13 “Control Structures” in *R programming for Data Science* and Chapter 21 “Iteration” in *R for Data Science* for details. -->
...
Pick the `map()` function you need and specify at least two main arguments (for more see documentation): 
