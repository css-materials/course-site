...
IDEA for next time: 
lecture 1: data structures -- this should go before but I might not be able to do that due to homework flow. 

lecture 2: finish data structure + conditional statements (and add more in-class practice and how to do conditional statements with a dataframe, use penguins_clean!)

lecture 3: loops slides and demo + loop exercises + maps/across + while loops
