...
(1) 
lecture 1: conditional statements + something else (and in general add more in-class practice and how to do conditional statements with a dataframe, use penguins_clean!)

lecture 2: loops slides and demo + loop exercises + maps/across + while loops

lecture 3: data structures -- this should go before but I might not be able to do that due to homework flow. 


(2) 
lecture 1: conditional statemetns + loops slides and demo
lecture 2: looop exercises + maps/across + while loops
