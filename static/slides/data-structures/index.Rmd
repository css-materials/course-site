...
**Takeway: All values in an atomic vector must to be of the same type**.
...
Example of filtering rows in a dataframe: is uses logical vectors!
```{r}
library(tidyverse)
...
Another thing to remember about logical vectors is that hey can only take two values TRUE or FALSE. When you do operations with them TRUE is evaluated as 1 and FALSE is evaluated as 0

```{r}
# operators with logical vectors 
