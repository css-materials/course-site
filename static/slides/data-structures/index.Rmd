...
If you assign a list as a column, R will try to coerce it into a vector format or store it as a list column, which behaves differently from standard vector columns.
