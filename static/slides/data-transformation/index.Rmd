...
# Intro: Programming as a form of problem-solving
...
## Errors to avoid with pipes: examples using a toy dataset
...
- HWs are cumulative (review first)
...
- Use ED Discusion (review our website FAQ before posting a question)
