...
## Some tips to tackle a coding assignment
...
A **syntactic name** is what R consider a **valid name** and consists only of letters, digits, . and _

A **non-syntactic name** is name that doesn’t follow these rules

You do not want to deliberately create non-syntactic names, BUT you need to understand how they work because you’ll come across them, for example with data that has been created outside R.
...
The word “color” has been duplicated 53940 times and tabulated using the count() function. Not what we intended!
...
Pipes automatically pass the output from the first line into the next line as the input.
