...
**Challenge:** use `fct_relevel()` from `forcats`, or `factor()` from base R to fix this!
...
### you do the same with `factor()` from base R!
...
* solution: check the documentation and your data to find the best function to achieve your desired results
