---
title: "Intermediate dpyr and data cleaning"
...
<!-- let's start with factors which is where we left the conversation last lecture and I promised we would retorn to them and explain them better -->
...
*There are many `dplyr` verbs! Memorize the most important ones (next slide) and look up others as needed*
...
* review these verbs with more examples. and we learn a few new ones
* learn how to deal with missing data and duplicates

We do that using the `more-dplr.Rmd` document. Access it by downloading today's in-class materials from the website 
