...
TASK 5: Display the total annual cost of attendance by school type (variables `cost` and `type`)

TASK 6: Display the total annual cost of attendance and net cost of attendance by school type (variables `cost`, `netcost`, `type`)
