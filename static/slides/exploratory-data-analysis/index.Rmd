...
`r chunk_reveal(chunk_name = "histogram", title = "### One continuous variable: **histogram**")`
...
`r chunk_reveal(chunk_name = "barplot",  title = "### One categorical variable: Bar chart")`
...
`r chunk_reveal(chunk_name = "barplot_cat", title = "### Stacked Bar chart")`
