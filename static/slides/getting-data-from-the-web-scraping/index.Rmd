...
2. Using the **SelectorGadget** see [here](https://selectorgadget.com/): 
* Read [here](https://rvest.tidyverse.org/articles/articles/selectorgadget.html)
...
* notice each page has about 10 URLs, we need to tell the scraper to turn page
...
If you need to simplify nested list for your scraping project **make sure to check today's class materials for a tutorial and examples of rectangling!**
