...
Improvement 2:
play around with R code to show how to extract the same info using
different tags for example the current code for title only uses "h1"
do code with the full tag -- DONE

Improvement 3:
add code on how to retrieve info on a mac -  DONE

Improvement 4:
spend more time in class on the documentation 
