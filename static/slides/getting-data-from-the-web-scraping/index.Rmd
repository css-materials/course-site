...
* `rvest` page "Web scraping 101": https://rvest.tidyverse.org/articles/rvest.html
* html and css for scraping: https://sscc.wisc.edu/sscc/pubs/webscraping-r/html.html
...
* See [here](https://selectorgadget.com/) to install and watch a short video on how to use it
...
* See [here](https://rvest.tidyverse.org/articles/selectorgadget.html#use) for step-by-step instructions on how to use it
