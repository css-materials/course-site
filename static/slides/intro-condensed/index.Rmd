...
* You won't become an R expert in five weeks. You will learn fundamental computational skills and techniques and, MOST IMPORTANTLY, you will gain the confidence needed to learn new techniques as you encounter them in your own research.
...
You will spend time finding resources to help (Google, ChatGPT are OK... but the documentation and the class materials should be the first places to go).

There will be moments of frustration. That's normal. Be patient with yourself!
...
* Keep your Zoom video on during lectures as much as possibile (good faith effort!)
...
If you had trouble with the setup, please stay after class to get help from us. Only students officially enrolled in the course can access R Workbench (please let me know if you are not officially enrolled).
...
In [this shared document](https://docs.google.com/document/d/1T0bp_mgeWhmm0GKFrSKfYWjeZryRXZTjsRzQuHC4j9U/edit?usp=sharing)

* Write your name
* Share your expectations or goals for this course 
* Share any concerns you might have and strategies you plan to adopt to be successful in this course
* Write any questions you have for us
...
Describe the panels:
Start from console, type in simple code, show it shows up in environment. Move to file, say this is where you communicate btw your computer and workbench, for example import a file from my machine into R workbench (e.g. with class roster on desktop), create a class-materials folder to keep things orgnaized
...
Create a Rmd as empty doc, stop here, move back to slides say: let's talk about R markdown first! I might go a bit fast on some of these slides but we ll be there for your reference and we ll do an in-class activty that ll review same content taught here
-->
...
Remember:
  ...
  * R Markdown: is just an extension of Markdown designed for R
...
This is a short summary; refer to the assigned readings for a more in-depth explanation!
...
Let's practice this workflow within RStudio! 

1. If you have not done it yet, complete the [Using Git with RStudio](https://computing-soc-sci.netlify.app/setup/git/git-with-rstudio/) tutorial from our website

2. Homework 1 workflow (remember to provide us your GitHub username and accept the invitation to join our GitHub organization!)
