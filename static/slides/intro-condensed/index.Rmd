...
* "There were times when I found functions that seemed to work, but weren’t covered in the slides or class materials, so I wasn’t sure if they were appropriate to use." *Advice: Generally, stick to the functions taught in class, as there's a reason for focusing on them. However, you can demonstrate both approaches—comparing the function used in class with the one you found.*

<br>

* I wish I had reviewed the in-class exercises afterward: they would have helped me prepare more effectively for the homework assignments, which were more difficult." *Advice: Play with the in-class exercises right after class or the day after when they are still fresh in your memory!*
