...
- you can write functions so that output from one function, is the first argument to the next function (functions composition)
...
I can do the samet thing using `%>%` (for more see [here](https://rpubs.com/tjmahr/pipelines_2015)):
```{r}
p <- c(1,2,3,NA)
...
You won't define anonymous functions a lot, but it is good to know they exist and recognize their syntax.
