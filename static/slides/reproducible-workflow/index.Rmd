...
In this class, we have been using a project-based workflow **by splitting work into project** (e.g., every homework assignment has been stored in a different R project, and every in-class practice exercise that you downloaded from the website has been stored as a standalone R project)

The **value of this approach**:
* keeps materials organized
* helps managing working directories, thus helps reproducibility
...
R studio has something called "RStudio Projects" (**`.Rproj`**) to help us implementing this workflow. R will automatically detect the working directory based on your project. Advantages: ensures portability and a reliable behavior.
...
For example, every homework and in-class exercise folder that we have been using in this course has a `.Rproj` file. This file helps R to automatically detect the working directory.
...
However, at times even that does not guarantee that we move away from using absolute file paths...
